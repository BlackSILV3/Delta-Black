const DB_Questions = {
    ...
    send: function() {
        ...
        if (type && type.value === 'text') {
            ...
            content = this.uploadedMediaData;
            if (!content) {
        ...
        var targetAgents = selectedOptions.includes('all') ? ['all'] : selectedOptions;
        
        DB_Storage.addQuestion({
        ...
        this.loadSent();
        alert('Directive transmitted successfully.');
    },
